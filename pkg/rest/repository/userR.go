...
func (r *UserRepository) GetUser(ctx context.Context, userID uuid.UUID) (models.User, error) {
	...
	if err != nil {
		return models.User{}, fmt.Errorf("error get user by id, %v", err)
	}
	return user, nil
}

func (r *UserRepository) UpdateProfile(ctx context.Context, userID uuid.UUID, input models.EnrichedFIO) error {
