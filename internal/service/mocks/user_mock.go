...
import (
	...
	models "github.com/Zavr22/EMTestTask/pkg/models"
...
func (m *MockUser) CreateUser(ctx context.Context, user *models.User) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockUser) GetAllUsers(ctx context.Context, offset int) ([]*models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUsers", ctx, offset)
...
func (mr *MockUserMockRecorder) GetAllUsers(ctx, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUsers", reflect.TypeOf((*MockUser)(nil).GetAllUsers), ctx, offset)
}

// GetUser mocks base method.
func (m *MockUser) GetUser(ctx context.Context, userID uuid.UUID) (models.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUser) UpdateProfile(ctx context.Context, userID uuid.UUID, input models.EnrichedFIO) error {
	m.ctrl.T.Helper()
